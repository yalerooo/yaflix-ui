...
const ACCENT_COLORS = [
  ...
  { name: "Pastel Pink", value: "340 75% 85%", color: "hsl(340, 75%, 85%)" },
  {
    name: "Pastel Lavender",
    value: "270 65% 85%",
    color: "hsl(270, 65%, 85%)",
  },
  { name: "Pastel Blue", value: "200 70% 80%", color: "hsl(200, 70%, 80%)" },
  { name: "Mint Green", value: "150 60% 80%", color: "hsl(150, 60%, 80%)" },
  {
    name: "Pastel Yellow",
    value: "50 70% 80%",
    color: "hsl(50, 70%, 80%)",
  },
  { name: "Pastel Coral", value: "10 75% 80%", color: "hsl(10, 75%, 80%)" },
  { name: "Pastel Peach", value: "20 80% 85%", color: "hsl(20, 80%, 85%)" },
  { name: "Pastel Sky", value: "190 65% 80%", color: "hsl(190, 65%, 80%)" },
];

export default function Page() {
  const { libraries, disabledLibraries, toggleDisableLibrary, reorderLibraries, scanLibrary } =
    useServer();
  const {
  ...
  return (
    ...
    >
      ...
      <section className="py-2.5 space-y-4 w-full max-w-2xl">
        <h2 className="text-base font-semibold">{t("settings.libraries")}</h2>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1">
                ...
                <Button
                  ...
                  className="h-8 w-8"
                  title={t("settings.scanLibraryTitle")}
                >
                  <RefreshCw
                    className={`w-4 h-4 ${
                      scanningLibraries.has(section.key) ? "animate-spin" : ""
                    }`}
                  />
                </Button>
              </div>
      ...
      <section className="py-2.5 space-y-4 w-full max-w-2xl">
        ...
        <div className="space-y-2">
          ...
          <Select value={language} onValueChange={(v) => updateLanguage(v as "es" | "en")}>
      ...
      <section className="py-2.5 space-y-4">
        <h2 className="text-base font-semibold">{t("settings.misc")}</h2>
